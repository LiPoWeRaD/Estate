...
const ServicesCard:FC<ServicesCardProps> = ({ title, description, icon1, icon2, icon3, icon4, header1, header2, header3, header4, text1, text2, text3, text4, banerTitle, link, banerText }) => {
    return (
        <>
            <div className="grid grid-cols-12 col-span-12 gap-5">
                ...
                <div id="ValuationMastery" className="grid grid-cols-12 p-6 border border-grey15 rounded-lg col-span-12 md:col-span-4">
                ...
                <div id="StrategicMarketing" className="grid grid-cols-12 p-6 border border-grey15 rounded-lg col-span-12 md:col-span-4">
                    <div className="flex items-center gap-2 col-span-12 mb-4">
                ...
                <div id="NegotiationWizardry" className="grid grid-cols-12 p-6 border border-grey15 rounded-lg col-span-12 md:col-span-4">
                    <div className="flex items-center gap-2 col-span-12 mb-4">
                ...
                <div id="ClosingSuccess" className="grid grid-cols-12 p-6 border border-grey15 rounded-lg col-span-12 md:col-span-4">
                    <div className="flex items-center gap-2 col-span-12 mb-4">
